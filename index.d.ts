...
export interface ReactJsonViewProps {
  ...
  /**
   * When provided, only keys included in onEditAllowKeys will display the edit icon.
   * If onEditAllowKeys.includes(key) is true, the edit icon will be shown.
   *
   * Default: false
   */
  onEditAllowKeys?: string[] | false;
  /**
